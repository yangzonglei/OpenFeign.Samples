...
using OpenFeign.Net48.Samples.Client.Resolvers;
...
namespace OpenFeign.Net48.Samples.Client.Clients
{
    ...
    /// 使用 {DemoApi:BaseUrl} 占位符从 IConfiguration 读取基址。
    /// </summary>
    [FeignClient(name: "demo-api", url: "http://localhost:17007", fallback: typeof(DemoFeignClientFallback), timeout: 5000)]
