...
using OpenFeign.Net48.Samples.Client.Clients;
using OpenFeign.Net48.Samples.Client.Models;
...
namespace OpenFeign.Net48.Samples.Client
{
    ...
    ///
    /// 前置条件：启动 OpenFeign.Samples.Api 项目（http://localhost:17007）。
    ///
    /// 本示例覆盖：
    ...
    internal class Program
    {
        ...
        {
            Console.WriteLine("============================================");
            Console.WriteLine(" OpenFeign.Net48 Samples Client");
            Console.WriteLine(" 目标框架: .NET Framework 4.8");
            Console.WriteLine(" 包: Yzl.Extensions.Http.OpenFeign.Net48 v0.1.1");
            Console.WriteLine("============================================");
            Console.WriteLine();
            ...
            // 2. 测试开始
            // ============================================================
            Console.WriteLine("测试开始 — 请确保 OpenFeign.Samples.Api 已在 http://localhost:17007 运行");
